...
@property (nonatomic, readonly, strong) AVAudioNode * _Nonnull inputNode;
- (void)detach;
...
/// Start playback
- (void)start;
- (void)playAt:(AVAudioTime * _Nullable)when;
/// Stop playback
- (void)stop;
/// Pause playback
- (void)pause;
...
- (void)scheduleFrom:(double)time to:(double)endTime avTime:(AVAudioTime * _Nullable)avTime;
...
/// \param audioUnit AVAudioUnitMIDIInstrument to wrap
///
- (nullable instancetype)initWithAudioUnit:(AVAudioUnitMIDIInstrument * _Nonnull)audioUnit OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger maxInserts;)
+ (NSInteger)maxInserts SWIFT_WARN_UNUSED_RESULT;
/// first node in chain, generally a player or instrument
@property (nonatomic, strong) AKNode * _Nullable input;
/// last node in chain, generally a mixer or some kind of output
@property (nonatomic, strong) AKNode * _Nullable output;
/// <code>availableEffects</code> is accessed from multiple thread contexts. Use a dispatch queue for synchronization.
@property (nonatomic, copy) NSArray<AVAudioUnitComponent *> * _Nonnull availableEffects;
/// <code>availableEffects</code> is accessed from multiple thread contexts. Use a dispatch queue for synchronization.
@property (nonatomic, copy) NSArray<AVAudioUnitComponent *> * _Nonnull availableInstruments;
/// Initialize the manager
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// request a list of Effects, will be returned async
- (void)requestEffectsWithCompletionHandler:(void (^ _Nullable)(NSArray<AVAudioUnitComponent *> * _Nonnull))completionHandler;
/// request a list of Instruments, will be returned async
- (void)requestInstrumentsWithCompletionHandler:(void (^ _Nullable)(NSArray<AVAudioUnitComponent *> * _Nonnull))completionHandler;
- (void)createEffectAudioUnit:(AudioComponentDescription)componentDescription completionHandler:(void (^ _Nonnull)(AVAudioUnitEffect * _Nullable))completionHandler;
- (void)createInstrumentAudioUnit:(AudioComponentDescription)componentDescription completionHandler:(void (^ _Nonnull)(AVAudioUnitMIDIInstrument * _Nullable))completionHandler;
- (void)removeEffectAt:(NSInteger)index;
- (void)insertAudioUnitWithName:(NSString * _Nonnull)name at:(NSInteger)index;
/// Create an instrument with a name and a completion handler
- (void)createInstrumentWithName:(NSString * _Nonnull)name completionHandler:(void (^ _Nullable)(AVAudioUnitMIDIInstrument * _Nullable))completionHandler;
/// Reset all effects
- (void)resetEffects;
...
/// to the output.
- (void)connectEffectsWithFirstNode:(AKNode * _Nullable)firstNode lastNode:(AKNode * _Nullable)lastNode;
@end
...
@property (nonatomic, copy) void (^ _Nonnull callback)(AKButton * _Nonnull);
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) AudioComponentDescription ComponentDescription;)
+ (AudioComponentDescription)ComponentDescription SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, strong) AKFMOscillatorAudioUnit * _Nullable internalAU;
/// Ramp Time represents the speed at which parameters are allowed to change
@property (nonatomic) double rampTime;
...
///
- (nonnull instancetype)initWithWaveform:(AKTable * _Nonnull)waveform carrierMultiplier:(double)carrierMultiplier modulatingMultiplier:(double)modulatingMultiplier modulationIndex:(double)modulationIndex attackDuration:(double)attackDuration decayDuration:(double)decayDuration sustainLevel:(double)sustainLevel releaseDuration:(double)releaseDuration detuningOffset:(double)detuningOffset detuningMultiplier:(double)detuningMultiplier OBJC_DESIGNATED_INITIALIZER;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
/// Function to stop or bypass the node, both are equivalent
- (void)stopWithNoteNumber:(uint8_t)noteNumber;
- (nonnull instancetype)initWithAvAudioNode:(AVAudioNode * _Nonnull)avAudioNode attach:(BOOL)attach SWIFT_UNAVAILABLE;
...
@property (nonatomic, readonly, strong) AVAudioConnectionPoint * _Nonnull avConnection;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
/// \param detuningMultiplier Frequency detuning multiplier
///
- (nonnull instancetype)initWithWaveformArray:(NSArray<AKTable *> * _Nonnull)waveformArray index:(double)index attackDuration:(double)attackDuration decayDuration:(double)decayDuration sustainLevel:(double)sustainLevel releaseDuration:(double)releaseDuration detuningOffset:(double)detuningOffset detuningMultiplier:(double)detuningMultiplier OBJC_DESIGNATED_INITIALIZER;
/// stops all notes
- (void)reset;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
/// Function to stop or bypass the node, both are equivalent
...
- (void)disconnectWithNodes:(NSArray<AVAudioNode *> * _Nonnull)nodes SWIFT_DEPRECATED_MSG("Use AudioKit.dettach(nodes:) instead");
@end


@interface AKNode (SWIFT_EXTENSION(AudioKit))
@property (nonatomic, readonly, strong) AVAudioNode * _Nonnull outputNode;
- (void)addConnectionPoint:(AKNode * _Nonnull)node bus:(NSInteger)bus SWIFT_DEPRECATED_MSG("", "connect(to:bus:)");
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) AudioComponentDescription ComponentDescription;)
+ (AudioComponentDescription)ComponentDescription SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic) BOOL internalRenderEnabled;
- (BOOL)renderToURL:(NSURL * _Nonnull)url seconds:(double)seconds settings:(NSDictionary<NSString *, id> * _Nullable)settings error:(NSError * _Nullable * _Nullable)error;
- (AVAudioPCMBuffer * _Nullable)renderToBufferWithSeconds:(double)seconds error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init:(AKNode * _Nullable)input OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithAvAudioNode:(AVAudioNode * _Nonnull)avAudioNode attach:(BOOL)attach SWIFT_UNAVAILABLE;
@end
...
/// \param detuningMultiplier Frequency detuning multiplier
///
- (nonnull instancetype)initWithWaveform:(AKTable * _Nonnull)waveform attackDuration:(double)attackDuration decayDuration:(double)decayDuration sustainLevel:(double)sustainLevel releaseDuration:(double)releaseDuration detuningOffset:(double)detuningOffset detuningMultiplier:(double)detuningMultiplier OBJC_DESIGNATED_INITIALIZER;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
/// Function to stop or bypass the node, both are equivalent
- (void)stopWithNoteNumber:(uint8_t)noteNumber;
- (nonnull instancetype)initWithAvAudioNode:(AVAudioNode * _Nonnull)avAudioNode attach:(BOOL)attach SWIFT_UNAVAILABLE;
...
/// \param detuningMultiplier Frequency detuning multiplier
///
- (nonnull instancetype)initWithWaveform:(AKTable * _Nonnull)waveform phaseDistortion:(double)phaseDistortion attackDuration:(double)attackDuration decayDuration:(double)decayDuration sustainLevel:(double)sustainLevel releaseDuration:(double)releaseDuration detuningOffset:(double)detuningOffset detuningMultiplier:(double)detuningMultiplier OBJC_DESIGNATED_INITIALIZER;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
/// Function to stop or bypass the node, both are equivalent
- (void)stopWithNoteNumber:(uint8_t)noteNumber;
- (nonnull instancetype)initWithAvAudioNode:(AVAudioNode * _Nonnull)avAudioNode attach:(BOOL)attach SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC8AudioKit12AKRotaryKnob")
@interface AKRotaryKnob : UIView
/// Current value of the slider
@property (nonatomic) double value;
@property (nonatomic) BOOL usesDiscreteValues;
@property (nonatomic) double discreteValueStep;
...
- (void)touchesMoved:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (UIColor * _Nonnull)indicatorColorForTheme SWIFT_WARN_UNUSED_RESULT;
- (UIColor * _Nonnull)knobBorderColorForTheme SWIFT_WARN_UNUSED_RESULT;
- (UIColor * _Nonnull)textColorForTheme SWIFT_WARN_UNUSED_RESULT;
- (void)drawRect:(CGRect)rect;
@end
...
- (float)objectAtIndexedSubscript:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
- (void)setObject:(float)newValue atIndexedSubscript:(NSInteger)index;
/// Initialize and set up the default table
/// \param tableType AKTableType of teh new table
///
/// \param size Size of the table (multiple of 2)
///
...
/// Offset of the phase
@property (nonatomic, readonly) NSInteger phaseOffset;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end


@interface AKTable (SWIFT_EXTENSION(AudioKit))
- (NSInteger)indexBefore:(NSInteger)i SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)indexAfter:(NSInteger)i SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)index:(NSInteger)i offsetBy:(NSInteger)n SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)distanceFrom:(NSInteger)start to:(NSInteger)end SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC8AudioKit11AKTableView")
...
@interface AVAudioMixerNode (SWIFT_EXTENSION(AudioKit))
@property (nonatomic, readonly, strong) AKInputConnection * _Nonnull nextInput;
@end
